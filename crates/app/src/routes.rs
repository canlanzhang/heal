...
use crate::handlers::{
    ...
    handler_list_users,handler_create_user,handler_get_user,handler_update_user,handler_delete_user,
...
pub fn get_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/v1/users", post(handler_create_user))
        .route("/api/v1/users/{id}", get(handler_get_user))
        .route("/api/v1/users/{id}", patch(handler_update_user))
        .route("/api/v1/users/{id}", delete(handler_delete_user))
